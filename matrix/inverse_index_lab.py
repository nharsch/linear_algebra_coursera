...
def movie_review(name):
    ...
    """
    return "{}: {}".format(name, ["see it","don't see it","meh"][random.randint(0,2)])
...
assert makeInverseIndex(['hello world','hello','hello cat','hellolot of cats']) == {'hello': {0, 1, 2}, 'cat': {2}, 'of': {3}, 'world': {0}, 'cats': {3}, 'hellolot': {3}}
